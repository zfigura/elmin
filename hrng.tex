...
Classical Low Tavarian (a.k.a.\ Classical Low Mittelic) has \textit{Yaraŋ} (\textipa{/ja\*{r}aŋ/}). This survives into Ksqyidy Tavarian as \textit{Yzaŋ} (\textipa{/jzaN/}), but not into other Low Tavarian dialects, which instead borrow the Dálx term.
